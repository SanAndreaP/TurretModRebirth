        ...
        implements IRecipeItem
{
    ...
    private RecipeItem(int count, ItemStack[] normalAlternatives, String[] oreDictAlternatives) {
        this.stackSize = count;
        this.drawTooltip = false;
    ...
    @Override
    public RecipeItem put(ItemStack... stacks) {
        List<ItemStack> newStacks = new ArrayList<>();
        newStacks.addAll(Arrays.asList(this.normalAlternatives));
    ...
    public RecipeItem copy() {
        ...
        return new RecipeItem(this.stackSize, stacksToCopy, this.oreDictAlternatives.clone());
    }
