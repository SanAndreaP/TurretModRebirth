...
public class TurretCryolatorRecipe
        extends AssemblyRecipe
{
    public TurretCryolatorRecipe(ResourceLocation id, String group, NonNullList<Ingredient> ingredients, int fluxPerTick, int processTime, ItemStack result) {
    ...
    public ItemStack getCraftingResult(IInventory inv) {
        ...
        IVariant  variant = TurretCryolator.VARIANTS.get(inv);

        if( !TurretCryolator.VARIANTS.isDefaultVariant(variant) ) {
