        ...
        extends Text
{
    ...
    public TurretName(boolean shadow, int wrapWidth, int lineHeight, FontRenderer fontRenderer, Map<String, Integer> colors, int textfieldWidth) {
            ...
            extends Text.Builder
    {
        ...
        @Override
        public TurretName get(IGui gui) {
            this.sanitize(gui);

            return new TurretName(this.shadow, this.wrapWidth, this.lineHeight, this.fontRenderer, this.colors, this.textfieldWidth);
        }
        ...
        public static TurretName fromJson(IGui gui, JsonObject data) {
