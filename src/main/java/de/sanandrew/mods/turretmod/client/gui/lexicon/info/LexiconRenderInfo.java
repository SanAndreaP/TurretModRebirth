...
{
    public static final String RENDER_INFO_ID = TmrConstants.ID + ":info";
    ...
    public void initPage(ILexiconEntry entry, ILexiconGuiHelper helper, List<GuiButton> globalButtons, List<GuiButton> entryButtons) {
        ...
        entryButtons.add(helper.getNewLinkButton(entryButtons.size(), 6, 89, "Drullkus (ion cannon model)", "https://minecraft.curseforge.com/members/Drullkus", helper.getFontRenderer(), true).get());
        entryButtons.add(helper.getNewLinkButton(entryButtons.size(), 6, 89, "Darkhax (helper code)", "https://minecraft.curseforge.com/members/Darkhax", helper.getFontRenderer(), true).get());
        entryButtons.add(helper.getNewLinkButton(entryButtons.size(), 6, 90, "Vazkii (rendering code)", "https://minecraft.curseforge.com/members/Vazkii", helper.getFontRenderer(), true).get());
