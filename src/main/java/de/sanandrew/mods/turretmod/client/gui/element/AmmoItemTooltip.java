...
public class AmmoItemTooltip
        extends Tooltip
{
    public static final ResourceLocation ID = new ResourceLocation(TmrConstants.ID, "info_ammo_ttip");
    ...
    public void update(IGui gui, JsonObject data) {
        ...
        this.getChild(CONTENT).get(AmmoTooltip.class).currStack = stack;
        this.visible = ItemStackUtils.isValid(stack);
