...
{
    public static final ContainerType<ContainerElectrolyteGenerator> ELECTROLYTE_GENERATOR = new ContainerType<>(ContainerElectrolyteGenerator.Factory.INSTANCE);
