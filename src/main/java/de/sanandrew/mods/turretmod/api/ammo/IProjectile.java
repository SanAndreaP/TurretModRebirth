...
/**
 * <p>A registry object defining a turret projectile.</p>
 *
 * @see IProjectileRegistry
 */
        ...
        extends IRegistryObject
{
    ...
    /**
     * <p>Invoked when the projectile updates.</p>
     *
     * @param turret The turret that owns this projectile.
     * @param projectile The projectile entity.
     */
    default void onUpdate(@Nullable ITurretInst turret, @Nonnull IProjectileInst projectile) { }
