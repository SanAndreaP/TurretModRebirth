        ...
        extends TurretInfoEntry
{
    ...
    public TurretInfoEntryMiscCraftable(UUID upgId) {
        this(UpgradeRegistry.INSTANCE.getUpgrade(upgId));
    }

    private TurretInfoEntryMiscCraftable(TurretUpgrade upgrade) {
    ...
    public void drawPage(GuiTurretInfo gui, int mouseX, int mouseY, int scrollY, float partTicks) {
        ...
        drawItem(gui.mc, 4, 18, UpgradeRegistry.INSTANCE.getUpgradeItem(this.upgrade), 2.0F);
