        ...
        extends CommonProxy
{
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        PatchouliHelper.preInit();

        RenderingRegistry.registerEntityRenderingHandler(EntityTurret.class, TurretRenderer::new);
    ...
    public static float[] forceGlow() {
        float[] prevBright = new float[] { GlStateManager.lastBrightnessX, GlStateManager.lastBrightnessY};
        GlStateManager.multiTexCoord2f(GlStateManager.ligh, 0xF0, 0x0);
        return prevBright;
    }
