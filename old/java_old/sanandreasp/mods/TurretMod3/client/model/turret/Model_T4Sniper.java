...
public class Model_T4Sniper extends ModelTurret_Base {
	...
	public Model_T4Sniper() {
		...
		Barrel = new ModelRenderer(this, 40, 0);
		Barrel.addBox(-0.5F, 1F, -19F, 1, 1, 16);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        Barrel.rotationPointX = (float) x * 3.5F;
        Barrel.rotationPointZ = (float) z * 3.5F;
        Barrel.rotationPointY = (float) y * 3.5F;
	}
