...
public class Model_T5Railgun extends ModelTurret_Base {
	...
	public Model_T5Railgun() {
	    ...
	    Barrel1 = new ModelRenderer(this, 46, 6);
	    Barrel1.addBox(-1.5F, 1F, -13F, 1, 1, 10);
	    Barrel1.setRotationPoint(0F, 0F, 0F);
		Barrel1.setTextureSize(128, 64);
		setRotation(Barrel1, 0F, 0F, 0F);
		Barrel2 = new ModelRenderer(this, 46, 6);
		Barrel2.addBox(0.5F, 1F, -13F, 1, 1, 10);
		Barrel2.setRotationPoint(0F, 0F, 0F);
		Barrel2.setTextureSize(128, 64);
		setRotation(Barrel2, 0F, 0F, 0F);
		Barrel3 = new ModelRenderer(this, 46, 6);
		Barrel3.addBox(-0.5F, 0F, -13F, 1, 1, 10);
		Barrel3.setRotationPoint(0F, 0F, 0F);
		Barrel3.setTextureSize(128, 64);
		setRotation(Barrel3, 0F, 0F, 0F);
		Barrel4 = new ModelRenderer(this, 46, 6);
		Barrel4.addBox(-0.5F, 2F, -13F, 1, 1, 10);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        double y = -Math.sin(turret.rotationPitch / (180F / (float)Math.PI)) * ((double)(turret.getShootTicks()) / (double)turret.getMaxShootTicks());

        x *= (Math.cos(turret.rotationPitch / (180F / (float)Math.PI)));
        z *= (Math.cos(turret.rotationPitch / (180F / (float)Math.PI)));
        ...
        Barrel1.rotationPointX = (float) x * 3.5F;
        Barrel1.rotationPointZ = (float) z * 3.5F;
        Barrel1.rotationPointY = (float) y * 3.5F;
        Barrel2.rotationPointX = (float) x * 3.5F;
        Barrel2.rotationPointZ = (float) z * 3.5F;
        Barrel2.rotationPointY = (float) y * 3.5F;
        Barrel3.rotationPointX = (float) x * 3.5F;
        Barrel3.rotationPointZ = (float) z * 3.5F;
        Barrel3.rotationPointY = (float) y * 3.5F;
        Barrel4.rotationPointX = (float) x * 3.5F;
        Barrel4.rotationPointZ = (float) z * 3.5F;
        Barrel4.rotationPointY = (float) y * 3.5F;
	}
