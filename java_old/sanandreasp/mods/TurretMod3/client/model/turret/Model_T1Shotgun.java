...
public class Model_T1Shotgun extends ModelTurret_Base {
	...
	public Model_T1Shotgun() {
	    ...
	    Barrel = new ModelRenderer(this, 24, 0);
	    Barrel.addBox(-2F, 0F, -9F, 4, 2, 6);
	    Barrel.setRotationPoint(0F, 0.5F, 0F);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        Barrel.rotationPointX = (float) x * 1.5F;
        Barrel.rotationPointZ = (float) z * 1.5F;
        Barrel.rotationPointY = (float) y * 1.5F + 0.5F;
