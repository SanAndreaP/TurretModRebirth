...
public class Model_T3Laser extends ModelTurret_Base {
...
//	public ModelRenderer LeftBarrel1C;
//	public ModelRenderer RightBarrel1C;
//	public ModelRenderer LeftBarrel2C;
//	public ModelRenderer RightBarrel2C;

	public Model_T3Laser() {
		textureWidth = 128;
		textureHeight = 64;
		...
		LeftBarrel1 = new ModelRenderer(this, 28, -2);
		LeftBarrel1.addBox(1.5F, 0.5F, -10F, 0, 2, 8);
		LeftBarrel1.setRotationPoint(0F, 0F, 0F);
		LeftBarrel1.setTextureSize(128, 64);
		setRotation(LeftBarrel1, 0F, 0F, 0F);
		LeftBarrel2 = new ModelRenderer(this, 16, 0);
		LeftBarrel2.addBox(0.5F, 1.5F, -10F, 2, 0, 8);
		LeftBarrel2.setRotationPoint(0F, 0F, 0F);
		LeftBarrel2.setTextureSize(128, 64);
		setRotation(LeftBarrel2, 0F, 0F, 0F);
		RightBarrel1 = new ModelRenderer(this, 16, 0);
		RightBarrel1.addBox(-2.5F, 1.5F, -10F, 2, 0, 8);
		RightBarrel1.setRotationPoint(0F, 0F, 0F);
		RightBarrel1.setTextureSize(128, 64);
		setRotation(RightBarrel1, 0F, 0F, 0F);
		RightBarrel2 = new ModelRenderer(this, 28, -2);
		RightBarrel2.addBox(-1.5F, 0.5F, -10F, 0, 2, 8);
		RightBarrel2.setRotationPoint(0F, 0F, 0F);
		RightBarrel2.setTextureSize(128, 64);
		setRotation(RightBarrel2, 0F, 0F, 0F);
//		LeftBarrel1C = new ModelRenderer(this, 28, -2);
//		LeftBarrel1C.addBox(1.5F, 0.5F, -10F, 0, 2, 8);
//		LeftBarrel1C.setRotationPoint(0F, 0F, 0F);
//		LeftBarrel1C.setTextureSize(128, 64);
//		setRotation(LeftBarrel1C, 0F, 0F, 0F);
//		LeftBarrel2C = new ModelRenderer(this, 16, 0);
//		LeftBarrel2C.addBox(0.5F, 1.5F, -10F, 2, 0, 8);
//		LeftBarrel2C.setRotationPoint(0F, 0F, 0F);
//		LeftBarrel2C.setTextureSize(128, 64);
//		setRotation(LeftBarrel2C, 0F, 0F, 0F);
//		RightBarrel1C = new ModelRenderer(this, 16, 0);
//		RightBarrel1C.addBox(-2.5F, 1.5F, -10F, 2, 0, 8);
//		RightBarrel1C.setRotationPoint(0F, 0F, 0F);
//		RightBarrel1C.setTextureSize(128, 64);
//		setRotation(RightBarrel1C, 0F, 0F, 0F);
//		RightBarrel2C = new ModelRenderer(this, 28, -2);
//		RightBarrel2C.addBox(-1.5F, 0.5F, -10F, 0, 2, 8);
//		RightBarrel2C.setRotationPoint(0F, 0F, 0F);
//		RightBarrel2C.setTextureSize(128, 64);
//		setRotation(RightBarrel2C, 0F, 0F, 0F);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.TurretHead.rotateAngleY =
        	...
        	this.RightBarrel1.rotateAngleY =
        	this.LeftBarrel1.rotateAngleY =
        	this.RightBarrel2.rotateAngleY =
        	this.LeftBarrel2.rotateAngleY =
//        	this.RightBarrel1C.rotateAngleY =
//        	this.LeftBarrel1C.rotateAngleY =
//        	this.RightBarrel2C.rotateAngleY =
//        	this.LeftBarrel2C.rotateAngleY =
        		f3 / (180F / (float)Math.PI);
        this.TurretHead.rotateAngleX =
            this.TurretAntennaI.rotateAngleX =
            this.TurretAntennaII.rotateAngleX =
        	this.RightBarrel1.rotateAngleX =
        	this.LeftBarrel1.rotateAngleX =
        	this.RightBarrel2.rotateAngleX =
        	this.LeftBarrel2.rotateAngleX =
//        	this.RightBarrel1C.rotateAngleX =
//        	this.LeftBarrel1C.rotateAngleX =
//        	this.RightBarrel2C.rotateAngleX =
//        	this.LeftBarrel2C.rotateAngleX =
            	f4 / (180F / (float)Math.PI);

        setStaticBody(f3);

        EntityTurret_T3Laser turret = (EntityTurret_T3Laser)entity;
...
//        }
//
//        RightBarrel1.rotationPointX = (float) xR * 3F;
//        RightBarrel1.rotationPointZ = (float) zR * 3F;
//        RightBarrel1.rotationPointY = (float) yR * 3F;
//
//        LeftBarrel1.rotationPointX = (float) xL * 3F;
//        LeftBarrel1.rotationPointZ = (float) zL * 3F;
//        LeftBarrel1.rotationPointY = (float) yL * 3F;
	}
